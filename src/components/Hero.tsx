    ...
    <section id="home" className="relative min-h-[92vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-grid-pattern">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full glass-pill border border-emerald-500/30 text-emerald-400 text-xs font-mono mb-8"
        >
          <span className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
            <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
          </span>
          <span>{portfolioData.profile.statusText}</span>
        ...
        <motion.p
          ...
          className="text-base sm:text-lg text-zinc-400 font-mono mb-3"
        >
          Hi, I&apos;m <span className="text-white font-medium">{portfolioData.profile.name}</span>
        </motion.p>
        ...
        <motion.p
          ...
          className="max-w-2xl text-base sm:text-lg text-zinc-300 mb-10 leading-relaxed font-light"
        >
          {portfolioData.profile.tagline} Focused on Next.js, Kubernetes, microservices, Go, and high-performance cloud infrastructure.
        </motion.p>
        ...
        >
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl glass-panel glass-panel-hover border border-white/10 text-white font-medium text-sm transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
            <Terminal size={16} className="text-emerald-400" />
            <span>Open Terminal Contact</span>
          </a>
        </motion.div>
        ...
        <motion.div
          ...
          className="flex items-center gap-3 glass-pill px-4 py-2 rounded-full border border-white/10"
        >
          <a
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 text-zinc-400 hover:text-sky-400 hover:bg-white/5 rounded-full transition-colors"
          ...
          <a
            ...
            className="p-2 text-zinc-400 hover:text-emerald-400 hover:bg-white/5 rounded-full transition-colors flex items-center gap-1.5 text-xs font-mono"
            aria-label="Send Email"
          >
            <Mail size={16} />
            <span className="hidden sm:inline">{portfolioData.profile.email}</span>
          </a>
        </motion.div>
      </div>
    </section>
